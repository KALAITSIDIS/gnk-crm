...
**The `rls` and `e2e` jobs apply all 76 migrations to a fresh database on every
...
| Migrations | **76**, latest `0076_final_value_and_report_honesty` |
...
npx supabase db reset   # re-runs all 76 migrations + seed
