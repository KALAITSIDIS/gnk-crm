...
| Hosted DB | `yjgirvzgoiywdojnpkpd` — **26 migrations**, `non_filename_versions` = 0, chain verifies, **73 events** |
| Data | `share_links` 2 (1 live, 1 revoked) · `tasks` 0 · `deals` 1 · **all of it operator test data** (§0) |
| Tests | **444 unit** · **31 RLS** · **171 desktop E2E** (4 skipped) — all three run in CI |
