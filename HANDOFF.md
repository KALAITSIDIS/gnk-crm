...
**2026-09-24, latest (evening, event payloads): task, document and lost-deal events carry ids, not typed text — LANDED on the operator's word ("merge #60 and verify the deploy"). No migration, nothing on hosted.**
