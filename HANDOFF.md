...
**2026-09-24, latest (late night, reservation release reason): a reservation's status event carries no typed release reason — LANDED on the operator's word ("merge #62 and verify the deploy"). No migration, nothing on hosted.**
