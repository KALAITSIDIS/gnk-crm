...
**2026-09-25, latest (afternoon, viewing feedback): a viewing's feedback event carries its rating, never the buyer's words — LANDED on the operator's word ("merge #65 and verify the deploy"). No migration, nothing on hosted.**
