...
**2026-09-26, latest (deal close at the database boundary): a deal reaches won or lost only through `close_deal` — LANDED on the operator's word ("applying 0118 to hosted, then merging go a head"). HOSTED IS AT 0118.**
