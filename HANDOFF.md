...
| 6 | **VAT treatment derived** | largest | **UNBLOCKED 2026-08-27 — `vat_property` is verified (0058).** Every figure it already held was CORRECT against the 2026 amendment and PwC guidance; nothing numeric changed. What was ADDED is the live transitional deadline: relief runs to **2026-12-31** (extended 2026-04-17) for permits issued/applied by 2023-10-31, under which the old 5%-on-first-200sqm-no-value-cap rule still applies. The old note said transitional rules "existed", past tense, which read as expired. **The build itself is still a decision** — this only removes the data blocker. |
