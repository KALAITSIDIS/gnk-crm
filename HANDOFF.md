...
| what is NOT done | **hosted has 1 project, 0 phases, 0 units, 0 price lists**, so an availability link there renders an empty matrix until the desk creates units. A real link sent to a real developer is still the next USAGE step |
