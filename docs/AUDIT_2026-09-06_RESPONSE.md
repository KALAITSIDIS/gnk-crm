...
Real photographs (≥1600 px wide) for **PAF0001, PAF0003 and PAF0004** — the borrowed set that reached all four listings on 2026-09-01 is now gone from every one of them (PAF0001 and PAF0002 cleared 2026-09-07 after 0088's hash backfill exposed that the 09-06 removal had missed them; HANDOFF's Photographs row); PAF0002's title and description before it publishes; two principal names, roles, bios and portraits; the lawyer's view on Law 71(I)/2010 wording; the domain cut-over (`SITE_URL`); whether floor plans are held under confidentiality; the enquiry retention period.
