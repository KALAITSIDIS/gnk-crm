...
**The `rls` and `e2e` jobs apply all 82 migrations to a fresh database on every
...
| Migrations | **82**, latest `0082_slip_second_attendee` |
...
npx supabase db reset   # re-runs all 82 migrations + seed
