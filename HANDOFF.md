...
**2026-09-26, latest (task / deal organisation isolation): a task belongs to the organisation of the deal it names, and a deal's reminder supersession stays inside that organisation — LANDED on the operator's word ("PROCEED WITH NESSESARY", then "you do it you have the access"). HOSTED IS AT 0119.**
