...
**2026-09-24, latest (night, lead lost reason): a lead's `lost` / `spam` event carries no typed reason — LANDED on the operator's word ("merge #61 and verify the deploy"). No migration, nothing on hosted.**
