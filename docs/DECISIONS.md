...
## T-audit-2026-09-23-property-floor-area — the property-validation brief, verified against `a321de5`: floor 9 of 3 and 0 m² areas were accepted on edit (and by every path but the create wizard), creation and editing disagreed (2026-09-23; migration 0113; NOT merged, NOT deployed, NOT applied to hosted)
