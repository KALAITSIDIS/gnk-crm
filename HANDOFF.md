...
On 2026-08-26 that returns **six entries and all six are operator decisions**.
...
|---|---|---|
| **Drop `contacts.preferences`** | 0043's saved searches superseded it; the column and its tab are still there driving nothing | one word |
