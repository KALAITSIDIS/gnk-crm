...
**The `rls` and `e2e` jobs apply all 77 migrations to a fresh database on every
...
| Migrations | **77**, latest `0077_dls_identity_and_schema_hygiene` |
...
npx supabase db reset   # re-runs all 77 migrations + seed
