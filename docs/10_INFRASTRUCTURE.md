...
**The `rls` and `e2e` jobs apply all 79 migrations to a fresh database on every
...
| Migrations | **79**, latest `0079_vat_transitional_condition` |
...
npx supabase db reset   # re-runs all 79 migrations + seed
