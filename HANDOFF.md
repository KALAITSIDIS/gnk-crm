...
**2026-09-25, latest (evening, importer identity): an imported person is named on the row, never in the chain — LANDED on the operator's word ("merge #66 and verify the deploy"). No migration, nothing on hosted.**
