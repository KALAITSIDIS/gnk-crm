...
**2026-09-26, latest (task / viewing organisation isolation): a task belongs to the organisation of the viewing it names, and a viewing's feedback-reminder supersession stays inside that organisation — BUILT on branch `fix/task-viewing-org-isolation` (worktree `.worktrees/gnk-crm/task-viewing-org`), landing in progress. HOSTED IS AT 0119.**
