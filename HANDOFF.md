...
**2026-09-25, latest (late morning, escalation recovery reason): an escalation recovery's event carries no typed reason. LANDED on the operator's word ("apply 0115 to hosted and merge #64"). HOSTED IS AT 0115.**
