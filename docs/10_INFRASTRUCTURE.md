...
**The `rls` and `e2e` jobs apply all 75 migrations to a fresh database on every
...
| Migrations | **75**, latest `0075_viewing_no_show_nudge` |
...
npx supabase db reset   # re-runs all 75 migrations + seed
