...
**The `rls` and `e2e` jobs apply all 69 migrations to a fresh database on every
...
| Migrations | **69**, latest `0069_public_listings_locale_shape` |
...
npx supabase db reset   # re-runs all 69 migrations + seed
